function createNewCard() {
  ...
  cardElement.innerHTML = `cardElement.innerHTML = "<div class='card-down'></div><div class='card-up'></div>";
`;
...
function createCards(parentElement, shuffledImageClasses) {
  ...
  for (let i = 0; i < 12; i++) {
    ...
    cardElement.classList.add(imageClasses[i]);
...
function resetGame() {
  ...
  flipEl = document.getElementById("flip-count");
  flipEl.innerHTML = "0";
  matchEl = document.getElementById("match-count");
  matchEl.innerHTML = "0";
